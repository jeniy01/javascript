...
// javascript에서의 자료형(data type)
// boolean, number, string, underfined, object, Symbol
...
// number type
// javascript에서는 정수와 실수를 구분하지 않고 모두 실수로 취급함
let integer = 1234;
let realNumber = 6.25;
...
// null : 객체를 초기화하는 값, 객체가 연결되어 있지 않은 변수의 값
x = null
console.log('x : ', x)
